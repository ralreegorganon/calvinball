...
class Mission:
    ...
    def __save_mission(self, package: bool, configure_for_editor: bool) -> str:
        ...
        if not configure_for_editor:
            ...
            load_trigger.actions.append(dcs.action.DoScriptFile(self.m.map_resource.add_resource_file(self.__common_resource("bigeye_ewr.lua"))))
            load_trigger.actions.append(dcs.action.DoScriptFile(self.m.map_resource.add_resource_file(self.__common_resource("HoundElint.lua"))))
