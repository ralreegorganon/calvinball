...
class WeaponsBronco:
    Fuel_Tank_150_gallons_ = {"clsid": "{150gal}", "name": "Fuel Tank 150 gallons", "weight": 499.5592}
    ParaTrooper = {"clsid": "{PARA}", "name": "ParaTrooper", "weight": 80}
    OV10_SMOKE = {"clsid": "{OV10_SMOKE}", "name": "OV10_SMOKE", "weight": 1}

inject_weapons(WeaponsBronco)
...
#ERRR {MK-81}
    ...
    class Pylon2:
        ...
        LAU_10R_pod___4_x_127mm_ZUNI__UnGd_Rkts_Mk71__HE_FRAG = (2, Weapons.LAU_10R_pod___4_x_127mm_ZUNI__UnGd_Rkts_Mk71__HE_FRAG)
...
#ERRR {MK-81}
    ...
    class Pylon3:
        ...
        LAU_10R_pod___4_x_127mm_ZUNI__UnGd_Rkts_Mk71__HE_FRAG = (3, Weapons.LAU_10R_pod___4_x_127mm_ZUNI__UnGd_Rkts_Mk71__HE_FRAG)
...
#ERRR {MK-81}
    ...
    class Pylon5:
        ...
        LAU_10R_pod___4_x_127mm_ZUNI__UnGd_Rkts_Mk71__HE_FRAG = (5, Weapons.LAU_10R_pod___4_x_127mm_ZUNI__UnGd_Rkts_Mk71__HE_FRAG)
        LAU_10_pod___4_x_127mm_ZUNI__UnGd_Rkts_Mk71__HE_FRAG = (5, Weapons.LAU_10_pod___4_x_127mm_ZUNI__UnGd_Rkts_Mk71__HE_FRAG)
#ERRR {MK-81}
    ...
    class Pylon6:
        ...
        LAU_10R_pod___4_x_127mm_ZUNI__UnGd_Rkts_Mk71__HE_FRAG = (6, Weapons.LAU_10R_pod___4_x_127mm_ZUNI__UnGd_Rkts_Mk71__HE_FRAG)
        LAU_10_pod___4_x_127mm_ZUNI__UnGd_Rkts_Mk71__HE_FRAG = (6, Weapons.LAU_10_pod___4_x_127mm_ZUNI__UnGd_Rkts_Mk71__HE_FRAG)

    class Pylon7:
        LAU_7_with_AIM_9P_Sidewinder_IR_AAM = (7, Weapons.LAU_7_with_AIM_9P_Sidewinder_IR_AAM)
